      ...
      <div className={`hidden md:block fixed inset-y-0 left-0 z-[100] w-64 bg-zinc-950 border-r border-zinc-900/50 transition-all duration-500`}>
        <div className="flex flex-col h-full p-6">
          ...
          <nav className="flex-1 space-y-1.5">
            ...
            {isAuthorizedAdmin && (
              <div className="pt-8 mt-8 border-t border-zinc-900/50 transition-opacity duration-500">
                <div className="flex items-center gap-2 px-4 mb-4">
                  <ShieldAlert className="w-3 h-3 text-maroon animate-pulse" />
                  <p className="label-meta text-[8px] uppercase tracking-widest text-maroon">
                    System Override
                  </p>
                </div>
                <DesktopNavItem
