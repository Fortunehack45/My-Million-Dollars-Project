  ...
  return (
    <div className="relative group inline-block">
      ...
      <div className={`absolute z-[200] opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-300 ease-out-expo delay-150 origin-bottom pointer-events-none ${positionClasses[position]}`}>
        <div className="frosted-glass border border-white/20 text-white text-[10px] font-mono font-black uppercase tracking-[0.2em] px-4 py-2.5 rounded-xl shadow-2xl whitespace-nowrap bg-zinc-950/95 backdrop-blur-2xl">
