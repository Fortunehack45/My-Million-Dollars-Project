         ...
         <div className={`max-w-7xl mx-auto transition-all duration-1000 ease-out ${footerVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 mb-16">
              ...
              <div className="lg:col-span-2 space-y-6">
                 ...
                 <div className="flex gap-4 pt-2">
                   <a href="#" className="p-2.5 bg-zinc-900 border border-zinc-800 rounded-lg text-zinc-400 hover:text-white hover:border-zinc-600 hover:bg-zinc-800 transition-all duration-300 group">
              ...
              <div className="lg:col-span-1 space-y-6">
                 <span className="text-[10px] font-black text-white uppercase tracking-widest border-b border-primary/20 pb-2 inline-block">Developers</span>
                 <div className="flex flex-col gap-3">
                    {['Documentation', 'API Reference', 'Status Page', 'Bug Bounty'].map(link => (
                      <Link key={link} to="/docs" className="text-xs text-zinc-500 hover:text-primary transition-colors flex items-center gap-2 group">
                        <ArrowUpRight className="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" />
                        {link}
                      </Link>
                    ))}
           ...
           <div className="pt-8 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-4">
              <span className="text-[10px] text-zinc-600 font-mono font-medium">
                 © 2026 ARGUS LABS. ALL RIGHTS RESERVED.
              </span>
