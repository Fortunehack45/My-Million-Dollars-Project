...
const Docs = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 pt-28 md:pt-32 pb-24">
      <SEO 
        title="Documentation"
        description="Comprehensive technical documentation for Argus Protocol, the institutional-grade orchestration layer for GhostDAG nodes."
      />
  ...
  "version": "0.1.0"
            ...
            <div className="mt-24 pt-8 border-t border-zinc-900 flex justify-between items-center">
              <div className="text-xs text-zinc-600">
                Last updated: <span className="text-zinc-300">February 18, 2026</span>
              </div>
