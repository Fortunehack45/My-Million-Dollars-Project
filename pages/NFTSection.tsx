  ...
  return (
    <div className="w-full min-h-[90vh] flex flex-col relative overflow-hidden pb-20 animate-in fade-in duration-700">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-[radial-gradient(circle_at_center,rgba(128,0,0,0.03),transparent_70%)]"></div>
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 border-b border-zinc-900 pb-12">
           <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-zinc-900 border border-zinc-800 rounded-full">
                 <Timer className="w-3 h-3 text-maroon animate-pulse" />
           ...
           <div className="bg-zinc-900/30 border border-zinc-800 p-6 rounded-2xl flex items-center gap-6 backdrop-blur-sm min-w-[300px]">
              <div className="w-12 h-12 bg-zinc-950 border border-zinc-800 rounded-xl flex items-center justify-center">
                 <Fingerprint className="w-6 h-6 text-maroon" />
              </div>
              <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
           ...
           <div className="lg:col-span-4 order-1 lg:order-2">
              <div className="relative group">
                 {/* Card Outer Glow */}
                 <div className="absolute -inset-4 bg-maroon/5 blur-[60px] rounded-full opacity-50 group-hover:opacity-100 transition-opacity"></div>
                    ...
                    <div className="h-full w-full bg-zinc-900/20 rounded-[2rem] border border-zinc-800/50 flex flex-col items-center justify-center relative overflow-hidden">
                       ...
                       <div className="relative z-10 flex flex-col items-center">
                          <div className="relative mb-12">
                             <div className="absolute inset-0 bg-maroon/20 blur-2xl rounded-full animate-pulse"></div>
                             <div className="relative w-28 h-28 bg-zinc-950 border border-zinc-800 rounded-full flex items-center justify-center shadow-2xl">
                                <Lock className="w-12 h-12 text-maroon" />
                             </div>
                             {/* Orbiting Elements */}
                             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 border border-maroon/10 rounded-full animate-spin-slow"></div>
                             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 border-t border-maroon/30 rounded-full animate-spin-slow"></div>
                          </div>
